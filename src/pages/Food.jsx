...
function Comida() {
  return (
    ...
    >
      <Link to="/comida/combos" style={{ textDecoration: 'none' }}>
        <MovieCard
          title="Combos"
      ...
      <Link to="/comida/palomitas" style={{ textDecoration: 'none' }}>
        <MovieCard
          title="Palomitas"
          image="https://tse3.mm.bing.net/th/id/OIP.vRN2OarFa_cJjyracsxgagHaHa?rs=1&pid=ImgDetMain&o=7&rm=3"
        />
      </Link>
      <Link to="/comida/refrescos" style={{ textDecoration: 'none' }}>
        <MovieCard
          title="Refrescos"
      ...
      <Link to="/comida/dulces" style={{ textDecoration: 'none' }}>
        <MovieCard
          title="Dulces"
